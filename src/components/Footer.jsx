    ...
    >
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-10 md:gap-14 relative z-10">
        ...
        >
          ...
          <span className="text-yellow-500">I Make It Unforgettable.</span>
        </motion.h2>
        ...
        >
          From weddings to corporate stages — the energy, the emotion, the experience — all crafted to leave a lasting impact.
        </motion.p>
